...
var _ = Describe("LrpLifecycle", func() {
	...
	Describe("ClaimActualLRP", func() {
		...
		JustBeforeEach(func() {
			_, claimErr = bbs.ClaimActualLRP(lrpKey, containerKey)
		})
	...
	Describe("StartActualLRP", func() {
		...
		JustBeforeEach(func() {
			_, startErr = bbs.StartActualLRP(lrpKey, containerKey, netInfo)
		})
